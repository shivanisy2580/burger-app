...
const Mobile = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div
      className={`fixed ${navStyle} right-0 transition-all duration-500 left-1 top-0 bottom-0 h-[100vh] bg-[#000000e0] z-[1002]`}
    >
      <ImCross
        onClick={closeNav}
      ...
      >
        <ul className="space-y-10">
          <li className="text-[30px] font-medium hover:text-yellow-400 text-white ">
            <Link href="/">Home</Link>
          </li>
          <li className="text-[30px] font-medium hover:text-yellow-400 text-white">
            <Link href="/">Shop</Link>
